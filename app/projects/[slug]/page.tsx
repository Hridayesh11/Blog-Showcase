...
export default function ProjectPage() {
  ...
  const { data } = useSWR(slug ? `/api/content/projects/${slug}` : null, fetcher)
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <article className="mx-auto max-w-3xl">
        <img
          src={
            data.cover || "/placeholder.svg?height=240&width=800&query=Project%20detail%20cover" || "/placeholder.svg"
          }
